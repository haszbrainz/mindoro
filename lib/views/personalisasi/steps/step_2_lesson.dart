...
class Step2Lesson extends StatefulWidget {
  final PageController pageController;
  const Step2Lesson({super.key, required this.pageController});

  @override
  State<Step2Lesson> createState() => _Step2LessonState();
}

class _Step2LessonState extends State<Step2Lesson> {
