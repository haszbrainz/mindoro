...
class Step1Class extends StatefulWidget {
  final PageController pageController;
  const Step1Class({super.key, required this.pageController});

  @override
  State<Step1Class> createState() => _Step1ClassState();
}

class _Step1ClassState extends State<Step1Class> {
